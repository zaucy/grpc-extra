...
export enum Status {
  ...
  /**
   * that we attempted to create (e.g., file or directory) already exists.
   */
  ALREADY_EXISTS = 6,
   ...
   *    the client should not retry unless they have first fixed up the 
   *    directory by deleting files from it.
   *  - Use FAILED_PRECONDITION if the client performs conditional REST 
